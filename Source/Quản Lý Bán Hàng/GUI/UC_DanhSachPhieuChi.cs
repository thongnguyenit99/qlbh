...
{
    public partial class UC_DanhSachPhieuChi : DevExpress.XtraEditors.XtraUserControl
    {
        UC_DanhSachPhieuChiBUS UC_DanhSachPhieuChiBUS = new UC_DanhSachPhieuChiBUS();
        ...
        {
            grvctdspc.DataSource = UC_DanhSachPhieuChiBUS.LayDanhSachPhieuChi(txttungay.EditValue.ToString(), txtdenngay.EditValue.ToString());
        }
        ...
        private void btnxoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string temp = grvrootdspc.GetRowCellValue(grvrootdspc.FocusedRowHandle, "MaPC").ToString();
            }
            catch
            {
                i = -1;
            ...
            if (i == 1)
            {
                if (UC_DanhSachPhieuChiBUS.XoaPhieuChi(grvrootdspc.GetRowCellValue(grvrootdspc.FocusedRowHandle, "MaPC").ToString(), grvrootdspc.GetRowCellValue(grvrootdspc.FocusedRowHandle, "MaPNH").ToString()) < 0)
                {
