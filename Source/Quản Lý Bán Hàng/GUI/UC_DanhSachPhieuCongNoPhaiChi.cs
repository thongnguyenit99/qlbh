...
{
    public partial class UC_DanhSachPhieuCongNoPhaiChi : DevExpress.XtraEditors.XtraUserControl
    {
        public delegate void CloseForm();
        public event CloseForm CloseFormSuccess = null;
        UC_DanhSachPhieuCongNoPhaiChiBUS UC_DanhSachPhieuCongNoPhaiChiBUS = new UC_DanhSachPhieuCongNoPhaiChiBUS();
        ...
        public UC_DanhSachPhieuCongNoPhaiChi()
        {
            InitializeComponent();
            this.grvrootdspcn.Columns["NhaCungCap"].Group();
            int tag1 = 27;
            ...
            // datasoure
            grvctdspcn.DataSource = UC_DanhSachPhieuCongNoPhaiChiBUS.LayThongTinPhieuChi_CongNo(txttungay.EditValue.ToString(), txtdenngay.EditValue.ToString());
            ...
            grvrootdspcn.GroupSummary.Add(item);
        }
        ...
        private void btnlapphieuchi_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string temp = grvrootdspcn.GetRowCellValue(grvrootdspcn.FocusedRowHandle, "ChungTu").ToString();
            }
            catch
            {
               i = -1;
            ...
            if(i == 1)
            {
                PhieuChiTheoChungTu phieuChiTheoChungTu = new PhieuChiTheoChungTu(grvrootdspcn.GetRowCellValue(grvrootdspcn.FocusedRowHandle, "ChungTu").ToString(), 0);
        ...
        private void btnxuat_Click(object sender, EventArgs e)
        {
            ...
            {
                grvrootdspcn.ExportToXlsx(fbd.SelectedPath + "\\DanhSachPhieuCongNoPhaiChi" + i + ".xlsx");
                i++;
            }
        }
