...
{
    public partial class UC_PhieuChiThanhToanNgay : DevExpress.XtraEditors.XtraUserControl
    {
        UC_PhieuChiThanhToanTraNgayBUS UC_PhieuChiThanhToanTraNgayBUS = new UC_PhieuChiThanhToanTraNgayBUS();
        ...
        public UC_PhieuChiThanhToanNgay()
        {
            InitializeComponent();
            ...
            btnlapphieuchi.Enabled = roleform.Them;
            ...
            grvroottrangay.Columns["KhachHang"].Group();
            ...
            grvroottrangay.GroupSummary.Add(item);

            GridColumn column = grvroottrangay.Columns["SoTien"];
        ...
        private void LoadData()
        {
            try
            {
                grvctdstn.DataSource = UC_PhieuChiThanhToanTraNgayBUS.LayThongTinPhieuNhapHangThanhToanNgay(txttungay.EditValue.ToString(), txtdenngay.EditValue.ToString());
            }
            catch { }
        }
        private void btnlapphieuchi_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string temp = grvroottrangay.GetRowCellValue(grvroottrangay.FocusedRowHandle, "ChungTu").ToString();
            }
            catch
            {
                check = -1;
            ...
            if (check == 1)
            {
                PhieuChiTheoChungTu phieuChiTheoChungTu = new PhieuChiTheoChungTu(grvroottrangay.GetRowCellValue(grvroottrangay.FocusedRowHandle, "ChungTu").ToString(), 0);
        ...
        private void btnxuat_Click(object sender, EventArgs e)
        {
            ...
            {
                grvroottrangay.ExportToXlsx(fbd.SelectedPath + "\\DS_PhieuChi_ThanhToanNgay" + i + ".xlsx");
                i++;
            }
        }
