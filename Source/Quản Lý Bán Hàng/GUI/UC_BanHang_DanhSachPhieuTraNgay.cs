...
{
    public partial class UC_BanHang_DanhSachPhieuTraNgay : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        UC_BanHang_DanhSachPhieuTraNgayBUS UC_BanHang_DanhSachPhieuTraNgayBUS = new UC_BanHang_DanhSachPhieuTraNgayBUS();
        public UC_BanHang_DanhSachPhieuTraNgay()
        {
            InitializeComponent();
            int tag1 = 26;
            ...
            grvroottrangay.Columns["TenKH"].Group();
        ...
        private void LoadData()
        {
            try
            {
                grvcttrangaypt.DataSource = UC_BanHang_DanhSachPhieuTraNgayBUS.LayThongTinPhieuThuTheoTraNgay(txttungay.EditValue.ToString(), txtdenngay.EditValue.ToString());
            }
            catch { }
        }
        ...
        private void btnlapphieuchi_Click(object sender, EventArgs e)
        {
            ...
            if (check == 1)
            {
                PhieuChiTheoChungTu phieuChiTheoChungTu = new PhieuChiTheoChungTu(grvroottrangay.GetRowCellValue(grvroottrangay.FocusedRowHandle, "ChungTu").ToString(), 1);
        ...
        private void btnxuat_Click(object sender, EventArgs e)
        {
            ...
            {
                grvroottrangay.ExportToXlsx(fbd.SelectedPath + "\\DS_PhieuThu_ThanhToanNgay" + i + ".xlsx");
                i++;
            }
        }
